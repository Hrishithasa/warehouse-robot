...
class WarehouseCanvas(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # --------------------------------------------------------------
        # Removed from the canvas intentionally.
        #
        # The hybrid mode/status panel is already displayed above the
        # warehouse in MainWindow. Keeping another copy here would place
        # a duplicate overlay on top of the maze.
        #
        # All navigation logic and all other visualizations remain
        # unchanged.
